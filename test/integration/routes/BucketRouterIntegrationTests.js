var
  ...
  RAS = '../../../server/services/RouteAccessService',
...
describe('bucket router path tests', function () {
  ...
  describe('POST /:bucketId/data', function () {
      ...
      withRequestData({user: {_id:123}}, function (reqDone) {
        var revert = routerMock.__set__({
          ...
          bucketService: {
            ...
            updateOne: function(id,payload,cb){
              id.should.equal('yay');
              payload.$push.data.videoId.should.equal('ouch'); // payload passed
              Object.keys(payload).length.should.equal(1);
              Object.keys(payload.$push).length.should.equal(1);
              cb('arrgh');
            }
          }
        });
      ...
      withRequestData({user: {_id:123}}, function (reqDone) {
        var revert = routerMock.__set__({
          ...
          bucketService: {
            ...
            updateOne: function(id,payload,cb){
              id.should.equal('yay');
              payload.$push.data.videoId.should.equal('ouch');
              Object.keys(payload).length.should.equal(1);
              Object.keys(payload.$push).length.should.equal(1);
              cb(null,{_id:7777});
            }
  ...
  describe('DELETE /:bucketId/data/:timestamp', function () {
      ...
      withRequestData({user: {_id:123}}, function (reqDone) {
        var revert = routerMock.__set__({
          ...
          bucketService: {
            ...
            updateOne: function(id,payload,cb){
              id.should.equal('yay');
              payload.$pull.data.___t.should.equal('ouch');
              Object.keys(payload).length.should.equal(1);
              Object.keys(payload.$pull).length.should.equal(1);
              cb('arrgh');
            }
          }
        });
